        ...
        <div className='container product'>
            <div className='filters'>
                ...
                <div className="category">
                    ...
                    <p className='option' onClick = {() => handleCategory("Electronics")}>Electronics</p>
                    <p className='option' onClick = {() => handleCategory("Women's clothing")}>Women's clothing</p>
                </div>
                <div className="category">
                    <p className = "cat_header">Price</p>
                    <p> $ {range? range: 0}</p>
                    <input className='range_input' type= "range" min= "0" max = "1000" value={range? range: 0} onChange = {(event) => handleRange(event)} />
                </div>
